...
public final class OperationDeniedException extends CustomParametrizedException {
    ...
    private static final String BATCHREQUEST_ENTITY_NAME = "batchrequest";
     ...
     * @return Instance of OperationDeniedException with entity's id
     */
    public static OperationDeniedException createBatchRequestReadOperation(String entityId) {
        return createEntityReadOperation(entityId, BATCHREQUEST_ENTITY_NAME);
    }
    ...
    public static OperationDeniedException createBatchRequestUpdateOperation(String entityId) {
        return createEntityUpdateOperation(entityId, BATCHREQUEST_ENTITY_NAME);
    }
