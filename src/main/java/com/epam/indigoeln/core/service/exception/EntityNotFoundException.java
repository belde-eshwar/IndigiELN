...
public final class EntityNotFoundException extends CustomParametrizedException {
     ...
     * 
     */
    private static final long serialVersionUID = 7182682641611770204L;
    ...
    /**
     * Creates instance of EntityNotFoundException class with batchRequest's id
     * if such id is not found.
     *
     * @param batchRequestId BatchRequest's identifier
     * @return Instance of EntityNotFoundException class with batchRequest's id
     */
    public static EntityNotFoundException createWithBatchRequestId(int batchRequestId) {
        return new EntityNotFoundException("The BatchQCRequest with id = " + batchRequestId + EXCEPTION_MESSAGE, batchRequestId+"");
    }
    
    public static EntityNotFoundException createWithBatchQCRequestId(String nbkBatchId) {
        return new EntityNotFoundException("The BatchQCRequest with id = " + nbkBatchId + EXCEPTION_MESSAGE, nbkBatchId+"");
    }
