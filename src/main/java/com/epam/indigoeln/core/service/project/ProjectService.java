...
public class ProjectService {
    ...
    public List<TreeNodeDTO> getAllProjectsAsTreeNodes(User user) {
        ...
        DBCollection collection = mongoTemplate.getCollection(Project.COLLECTION_NAME);

         DBCursor projects = (user == null) ? collection.find()
    ...
    public TreeNodeDTO getProjectAsTreeNode(String projectId) {
        ...
        DBCursor project = collection.find(searchQuery);
        if (project.hasNext()) {
