...
public class NotebookService {
    ...
    public List<TreeNodeDTO> getAllNotebookTreeNodes(String projectId, User user) {
        ...
        DBObject project = projectCollection.findOne(new BasicDBObject().append("_id", projectId));
        if (project == null) {
        ...
        if (project.get("notebooks") instanceof Iterable) {
            ...
            List<DBObject> notebooks = new ArrayList<DBObject>();
    ...
    public TreeNodeDTO getNotebookAsTreeNode(String projectId, String notebookId) {
        TreeNodeDTO result;
        DBCollection notebookCollection = mongoTemplate.getCollection(Notebook.COLLECTION_NAME);
        DBObject notebook = notebookCollection.findOne(new BasicDBObject().append("_id", projectId + "-" + notebookId));
        if (notebook == null) {
