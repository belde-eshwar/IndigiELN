...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                //batchRequest
                .antMatchers(HttpMethod.POST, "/api/batchRequests").hasAnyAuthority(PROJECT_CREATORS)
                //.antMatchers(HttpMethod.GET, "/api/pendingBatchRequests").hasAnyAuthority(PROJECT_CREATORS)
                .antMatchers(HttpMethod.PUT, "/api/batchRequests").hasAnyAuthority(PROJECT_CREATORS)
                // role resource
