...
public class ExperimentTreeNodeDTO extends TreeNodeDTO {
    ...
    public ExperimentTreeNodeDTO(DBObject obj) {
        ...
        String experimentName = String.valueOf(obj.get("name"));
        int experimentVersion = Integer.parseInt(String.valueOf(obj.get("experimentVersion")));
        boolean lastVersion = Boolean.parseBoolean(String.valueOf(obj.get("lastVersion")));
