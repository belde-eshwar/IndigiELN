...
public class PermissionChanges<E extends BasicModelObject> {
     ...
     */
    public Set<UserPermission> getNewPermissions() {
        return newPermissions;
    }

    /**
     * @return the updatedPermissions
     */
    public Set<UserPermission> getUpdatedPermissions() {
        return updatedPermissions;
    }

    /**
     * @return the removedPermissions
     */
    public Set<UserPermission> getRemovedPermissions() {
